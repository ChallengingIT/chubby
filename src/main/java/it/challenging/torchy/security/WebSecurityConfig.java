        ...
        http
            ...
            .authorizeHttpRequests(auth ->
                auth.requestMatchers("/api/auth/**").permitAll()
                    ...
                    .requestMatchers("/api/auth/mapp/delete").hasAnyAuthority("USER","PREMIUM")
                    ...
                    .requestMatchers("/church/**").hasAnyAuthority("USER","PREMIUM")
                    ...
                    .requestMatchers("/qr/**").hasAnyAuthority("USER","PREMIUM")
