...
public class AttivitaRecruiting implements Serializable {
    ...
    @Column(length = 90, nullable = false, name = "nome_candidato")
    private String nomeCandidato;

    @Column(length = 90, nullable = false, name = "cognome_candidato")
    ...
    @Column(name="id_intervista")
    private Integer idIntervista;
    ...
    public boolean equals(Object o) {
        ...
        AttivitaRecruiting appuntamento = (AttivitaRecruiting)o;
