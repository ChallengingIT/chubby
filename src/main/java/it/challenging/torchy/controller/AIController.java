                ...
                for (String s : keyCandidati) {
                    if (message.toLowerCase().contains(s)) {
                        ...
                        switch (s) {
                            ...
                            //TODO
                            case Constants.CANDIDATI_DATA_DI_NASCITA, Constants.CANDIDATI_NATO,
                                 Constants.CANDIDATI_ANNI:
                ...
                for (String s : keyAziende) {
                    if (message.toLowerCase().contains(s)) {
                        switch (s) {
                            ...
                            //TODO
                            case Constants.AZIENDE_SCADE, Constants.AZIENDE_SCADENZA_DEL_CONTRATTO,
                                 Constants.AZIENDE_SCADENZA_CONTRATTO:
                            ...
                            case Constants.AZIENDE_SETTORE, Constants.AZIENDE_SETTORE_DI_MERCATO,
                                 Constants.AZIENDE_SETTORE_MERCATO:
