...
public interface CandidatoRepository extends JpaRepository<Candidato, Integer> {
    ...
    Page<Candidato> findAllByOrderByDataUltimoContattoDesc(Pageable p);
    ...
    @Query(value= """
         ...
         left join tipologia_candidato tc on (c.id = tc.id_candidato)
         left join tipo_candidato ttc on (c.id = ttc.id_candidato)
         left join livello_candidato lc on (c.id = lc.id_candidato)
