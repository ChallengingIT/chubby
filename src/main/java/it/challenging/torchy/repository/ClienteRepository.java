...
public interface ClienteRepository extends JpaRepository<Cliente, Integer> {
    ...
    @Query(value= """
         ...
         order by c.denominazione asc
        """,nativeQuery=true)
    Long countRicercaByIdaAndOwner_IdAndTipologiaAndDenominazione(
            Double idaMin, Double idaMax, Integer owner, String tipologia, String denominazione);
    ...
    @Query(value= """
         ...
         order by c.denominazione asc
        """,nativeQuery=true)
    Long countRicercaByUsernameAndIdaAndTipologiaAndDenominazione(
            String username, Double idaMin, Double idaMax, String tipologia, String denominazione);
}